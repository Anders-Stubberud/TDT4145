...
while True:
    oppgave = int(input('''
                    hvilken oppgave ønsker du å utføre?
                    \nSkriv 0 for opprette databasen med startdata'en, [1,2,3,4,5,6,7] for individuelle oppgaver,
                    8 for å kjøre alle oppgavene, 9 for å slette databasen, eller 10 for å avslutte. 
                    '''))
    ...
    if oppgave == 0:
        ...
        print('Utfører oppgave 1: setter inn data i databasen')
